export const SBT_CONTRACT = "ascendant.nearlegion.near";
export const KV_ACCOUNT = "contextual.near";
export const KV_ACCOUNTS = [KV_ACCOUNT, "nearlegion.near"];
...
export const FEED_CHANNEL_ID = "b3579012df41fcb27e7b14c163a0f3b1cb4333f98638660d38e9b28b63379825";
